...
combos.add_val(
    ...
    [
        "-PARASITE_CYCLE_LOSS_PROP 1.0 -MUTUALIST_CYCLE_GAIN_PROP 1.0",
        "-PARASITE_CYCLE_LOSS_PROP 0.90 -MUTUALIST_CYCLE_GAIN_PROP 0.90",
        "-PARASITE_CYCLE_LOSS_PROP 0.75 -MUTUALIST_CYCLE_GAIN_PROP 0.75",
        "-PARASITE_CYCLE_LOSS_PROP 0.5 -MUTUALIST_CYCLE_GAIN_PROP 0.5",
        "-PARASITE_CYCLE_LOSS_PROP 0.25 -MUTUALIST_CYCLE_GAIN_PROP 0.25"
    ]
)
